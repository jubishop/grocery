...
The current SQLite corpus retains **55,158 product identities** and **46,161 dated price observations**. The website and CSV expose all **40,419 products with a current retained price**: **35,180** have one comparison-eligible store, **1,004 catalog-only products** have an ambiguous selling unit and remain excluded from comparisons, and **4,235 strict products** appear at two or more compatible stores. Of the comparable set, **1,034 products appear at three or more stores**, and **89 products are confirmed across all five core stores**. The corpus includes **11,061 QFC direct-catalog records**, **3,342 accepted QFC cross-source matches**, and **711 accepted Whole Foods cross-source matches**; every core two-store pairing has at least **197 exact products** in common.
